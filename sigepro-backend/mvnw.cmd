...
:init
@REM Decide on the wrapper command
set WRAPPER_JAR_PATH=%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar
if exist "%WRAPPER_JAR_PATH%" goto runWrapper
echo.
echo ERROR: Maven wrapper JAR not found at: %WRAPPER_JAR_PATH%
echo Please download it or set MAVEN_DIST_URL to download automatically.
goto fail
